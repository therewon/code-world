  ...
  return (
    <article className="group relative overflow-hidden rounded-[20px] border border-[#e7e9ed] bg-white transition duration-200 hover:-translate-y-[5px] hover:shadow-[0_22px_48px_rgba(24,34,49,.1)]">
      <div className="relative h-[330px] overflow-hidden bg-[#eceef1] max-[680px]:h-[390px]">
        ...
        />
        {graduate && (
          <span className="absolute left-3.5 top-3.5 rounded-full bg-[#0869f7] px-2.5 py-[7px] text-[10px] font-extrabold text-white">Məzunumuz</span>
        )}
      </div>
      <div className="relative px-5 pb-[22px] pt-[18px]">
        ...
        <span className="absolute right-[18px] top-[18px] grid size-[29px] place-items-center rounded-full bg-[#171b22] text-[11px] font-black text-white" aria-label="LinkedIn profili">in</span>
      </div>
    </article>
  );
}
