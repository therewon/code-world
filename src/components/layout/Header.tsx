  ...
  return (
    <header className="absolute inset-x-0 top-0 z-20 py-5.5 text-white max-[680px]:pt-3.75">
      <div className="site-container flex items-center justify-between gap-6">
        ...
        <nav
          className={`${menuOpen ? "max-[980px]:flex" : "max-[980px]:hidden"} flex items-center gap-1.75 rounded-full border border-white/10 bg-[#040811ad] p-1.5 backdrop-blur-[14px] max-[980px]:absolute max-[980px]:left-5 max-[980px]:right-5 max-[980px]:top-19 max-[980px]:flex-col max-[980px]:items-stretch max-[980px]:rounded-[18px] max-[980px]:bg-[#050c1cf7] max-[980px]:p-3.5`}
        ...
        <div className="flex items-center gap-3 max-[680px]:gap-2">
          ...
          {user ? (
            <div className="relative">
              <button
                type="button"
                className="flex min-h-10.5 cursor-pointer items-center justify-center gap-2 rounded-full hover:text-[#0869f7] hover:bg-white hover:border-[#0869f7] bg-[#0869f7] px-4.5 text-[13px] font-extrabold text-white shadow-[0_10px_25px_rgba(5,98,242,.25)] max-[680px]:min-h-10 max-[680px]:px-3.5"
            ...
            <Link
              to="/daxil-ol"
              className="flex min-h-10.5 items-center justify-center rounded-full bg-[#0869f7] hover:text-[#0869f7] hover:bg-white hover:border-[#0869f7] hover:border px-4.5 text-[13px] font-extrabold text-white shadow-[0_10px_25px_rgba(5,98,242,.25)] max-[680px]:min-h-10 max-[680px]:px-3.5"
            >
              Daxil ol
            </Link>
          )}
