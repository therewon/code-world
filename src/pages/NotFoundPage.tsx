...
export function NotFoundPage() {
  return (
    <section className="flex min-h-[720px] flex-col items-center justify-center px-5 pb-20 pt-[140px] text-center">
      ...
      <Link to="/" className="site-button bg-[#0869f7] text-white shadow-[0_13px_30px_rgba(0,94,255,.25)] hover:shadow-[0_16px_35px_rgba(0,94,255,.34)]">Əsas səhifəyə qayıt</Link>
    </section>
  );
}
